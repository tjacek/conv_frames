...
def learning_logistic_regression(dataset,n_epochs=1000,learning_rate=0.13, batch_size=5):
    ...
    timer = utils.Timer()#timeit.default_timer()
...
if __name__ == "__main__":
    ...
    cls=learning_logistic_regression(dataset)
